...
var Bot = /** @class */ (function (_super) {
    ...
    Bot.prototype.ready = function () {
        ...
        var intervalId = setInterval(function () {
            ...
            if (Math.floor((new Date().getTime() / 1000) / 60) * 60 > oldMinute) {
                _this.log("!!! New minute detected, Starting cron Watcher at minute " + new Date().getMinutes() + " !!!");
                _this.cronWatcher();
    ...
    Bot.prototype.cronWatcher = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var messagesData, freqPromise, ponctualPromise, _loop_1, this_1, _i, messagesData_1, message, state_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        _loop_1 = function (message) {
                            ...
                            if (data.type == MessageModel_1.MessageType.Ponctual && data.timestamp == timestamp) {
                                ...
                                try {
                                    var promise = channel_1.send(data.sys_content || data.message);
                                    promise.then(function (message) { return _this.onMessageSend(MessageModel_1.MessageType.Ponctual, message); });
                                    promise["catch"](function (e) { return _this.onMessageError(MessageModel_1.MessageType.Ponctual, channel_1.id, e); });
                                    freqPromise.push(promise);
                                }
                                catch (e) {
                                    this_1.onMessageError(MessageModel_1.MessageType.Ponctual, channel_1.id, new Error("Before sending Ponctual Message error"));
                                }
                            }
                                ...
                                if (timestampToExec == timestamp) {
                                    var channel_2 = this_1.bot.channels.cache.get(data.channel_id);
                                    try {
                                        var promise = channel_2.send(data.sys_content || data.message);
                                        promise.then(function (message) { return _this.onMessageSend(MessageModel_1.MessageType.Frequential, message); });
                                        promise["catch"](function (e) { return _this.onMessageError(MessageModel_1.MessageType.Frequential, channel_2.id, e); });
                                        ponctualPromise.push(promise);
                                    }
                                    catch (e) {
                                        this_1.onMessageError(MessageModel_1.MessageType.Frequential, channel_2.id, new Error("Before sending Frequencial message error"));
                                    }
                                }
                            }
                        };
                        ...
                        return [4 /*yield*/, Promise.all(freqPromise)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, Promise.all(ponctualPromise)];
                    case 3:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.dbManager.Guild.count()];
                    case 1:
                        lengthServer = _a.sent();
                        return [4 /*yield*/, this.dbManager.User.count()];
                    case 2:
                        lengthUsers = _a.sent();
                        return [4 /*yield*/, this.dbManager.Message.count()];
                    case 3:
                        lengthMessages = _a.sent();
